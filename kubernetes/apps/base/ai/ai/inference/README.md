...
- `qwen38.yaml` remains at `replicas: 0` solely to retain its completed
  per-Spark checkpoint caches for a fast rollback; it owns no active route or
  GPU while GLM is running.
